...
class PatientConditionController extends Controller
{
    ...
    public function mobilityTestFour(Request $request)
    {
        ...
        Mail::to('krinamota92@gmail.com')->send(new MobilityTestMail($mobilityData));
    ...
    public function results(Request $request)
    {
        ...
        Mail::to('krinamota92@gmail.com')->send(new MobilityResultMail($mobilityResultData));
