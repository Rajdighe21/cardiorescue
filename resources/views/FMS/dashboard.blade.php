        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h5 class="font-weight-bolder text-white mb-0">Hello, {{ strtoupper(auth()->user()->name) }}</h5>
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="{{ route('fms.logout') }}" class="nav-link text-white font-weight-bold px-0">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th
                                                ...
                                                Patients Age</th>
                                            <th
                                                class="text-left text-uppercase text-secondary text-xs font-weight-bolder">
                                                Description</th>
                                            {{-- <th
                                                class="text-center text-uppercase text-secondary text-xs font-weight-bolder">
                                                Session Status</th>
                                        ...
                                        @forelse ($patients as $patient)
                                            <tr>
                                                <td class="align-middle text-center">
                                                    ...
                                                    <h6 class="text-sm mb-0">{{ $patient->patient_name }}</h6>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Patient ID:</p>
                                                    <h6 class="text-sm mb-0">
                                                        CR0000{{ $patient->id }}</h6>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Appointment Date:</p>
                                                    <h6 class="text-sm mb-0">
                                                        {{ \Carbon\Carbon::parse($patient->regi_date)->format('Y-m-d ') }}
                                                    </h6>
                                                </td>
                                                <td class="align-middle text-center">
                                                ...
                                                <td class="align-middle text-left">
                                                    <p class="text-xs font-weight-bold mb-0"> {{ $patient->describe_problem }}</p>
                                                </td>
