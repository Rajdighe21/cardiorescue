...
<div class="col-xl-8 col-lg-8 content-right" id="start">
    <div id="wizard_container">
        ...
        <!-- /top-wizard -->
        <form id="wrapped" class="indexClass" method="POST" action="{{ route('Goal') }}">
            @csrf
                ...
                <div class="step">
                    ...
                    <div class="form-group">
                        ...
                        <label class="container_radio version_2">1 Year
                            <input type="radio" name="SufferingDuration" value="1 Year" class="required">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container_radio version_2">2 Years
                            <input type="radio" name="SufferingDuration" value="2 Years" class="required">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container_radio version_2">3 Years
                            <input type="radio" name="SufferingDuration" value="3 Years" class="required">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container_radio version_2">4 Years
                            <input type="radio" name="SufferingDuration" value="4 Years" class="required">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container_radio version_2">5 Years
                            <input type="radio" name="SufferingDuration" value="5 Years" class="required">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container_radio version_2">Above 5 Years
                            <input type="radio" name="SufferingDuration" value="Above 5 Years" class="required">
                            <span class="checkmark"></span>
                        </label>
                    </div>
        ...
        <div id="bottom-wizard">
            <a href="{{ route('TenTest') }}"> <button type="button" name="backward"
