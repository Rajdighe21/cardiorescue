...
<div class="col-xl-8 col-lg-8 content-right" id="start">
    <div id="wizard_container">
        <form id="wrapped" class="indexClass" method="POST" action="{{ route('health') }}">
            @csrf
                ...
                <div class="step">
                    ...
                    <div class="form-group">
                        <label class="container_check version_2">Improve Mobility
                            <input type="checkbox" name="PatientGoalMobility" value="Mobility" class="required">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container_check version_2">Increase Range of Motion
                            <input type="checkbox" name="PatientGoalMobility" value="Range of Motion"
                                class="required">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container_check version_2">Pain Reduction
                            <input type="checkbox" name="PatientGoalMobility" value="Pain Reduction"
                                class="required">
                            <span class="checkmark"></span>
                        </label>
                        <label class="container_check version_2">Improving Day to Day Functional Activities
                            <input type="checkbox" name="PatientGoalMobility"
                                value="Day to Day Functional Activities" class="required">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                </div>
    ...
    <div id="bottom-wizard">
        <a href="{{ route('FromPastYears') }}"> <button type="button" name="backward"
