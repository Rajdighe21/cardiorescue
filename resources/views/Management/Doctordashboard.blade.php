                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="{{ route('doctor.logout') }}" class="nav-link text-white font-weight-bold px-0">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <a href="{{ route('patients.protocol') }}">
                                        <div class="numbers">
                                            ...
                                            <p class="mb-0">
                                                <span class="text-success text-sm font-weight-bolder">Click
                                                    Here</span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped align-items-center mb-0">
                                    ...
                                    <tbody>
                                        @forelse (auth()->user()->unreadNotifications as $notification)
                                            <tr>
                                                <td class="align-middle text-center">
                                                    ...
                                                    <h6 class="text-sm mb-0">{{ $notification->data['name'] }}</h6>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Patient ID:</p>
                                                    <h6 class="text-sm mb-0">
                                                        CR0000{{ $notification->data['patient_id'] }}</h6>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Appointment Date:</p>
                                                    <h6 class="text-sm mb-0">
                                                        {{ \Carbon\Carbon::parse($notification->data['app_date'])->format('Y-m-d H:i') }}
                                                    </h6>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <p class="text-xs font-weight-bold mb-0">Session Number:</p>
                                                    <h6 class="text-sm mb-0">
                                                        @if ($notification->data['session_no'] == 0)
                                                            Assessment
                                                        @elseif ($notification->data['session_no'] == -1)
                                                            Consultation
                                                        @else
                                                            {{ $notification->data['session_no'] }}
                                                        @endif
                                                    </h6>
                                                </td>
                                                <td class="align-middle text-center">
                                                    @if ($notification->data['session_no'] == 0)
                                                        <a href="{{ route('assesment-view', $notification->data['patient_id']) }}"
                                                    ...
                                                    @elseif ($notification->data['session_no'] == -1)
                                                        <a href="{{ route('doctor.consultation', $notification->id) }}"
                                                            class="btn btn-primary">
                                                            <p class="text-sm text-white font-weight-bold mb-0">
                                                                Consultation
                                                            </p>
                                                    ...
                                                    @else
                                                        <p class="text-sm text-muted font-weight-bold mb-0">NA</p>
                                                    @endif
                                                </td>
                                                <td class="align-middle text-center">
                                                    <a href="{{ route('doctor.markAsRead', $notification->id) }}"
                                                        class="btn btn-primary">
                                                        <i class="ni ni-calendar-grid-58"></i> Session End
                                                    </a>
                                                </td>
                                                <td class="align-middle text-center">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center text-muted">No notifications
                                                    available.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
