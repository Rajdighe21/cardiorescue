                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Patient Appointment</p>
                            <button class="btn btn-secondary btn-sm ms-auto"> <a href="{{ route('manage.bookApp') }}"
                                    style="color: aliceblue">Back</a></button>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('manage.doctorAppBook') }}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" name="name"
                                            type="text" placeholder="Name" value="{{ $patientInfo->patient_name }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('age') is-invalid @enderror" name="age"
                                            type="text" placeholder="90Years" value="{{ $patientInfo->date_of_birth }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Next Appointment
                                            Date</label>
                                ...
                                <div class="col-md-6">
                                    <label for="example-text-input" class="form-control-label">Next Session Number</label>
                                    <select class="form-control @error('session_no') is-invalid @enderror"
                                        ...
                                        <option disabled selected>Selected a Session</option>
                                         ...
                                         <option value="0">Assesssment</option>
                                        @for ($i = 1 ; $i <= 60 ;$i++)
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('doctor_id') is-invalid @enderror"
                                        data-toggle="select" title="Simple select" data-live-search="true"
                                        data-live-search-placeholder="Search ..." name="doctor_id">
