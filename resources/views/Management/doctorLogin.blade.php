    ...
    <main class="main-content  mt-0">
        <section>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                @if ($errors->any())
                                    <div
                                        style="background-color: #f8d7da; color: #721c24; padding: 10px; border: 1px solid #f5c6cb; border-radius: 5px;">
                                ...
                                <div class="card-header pb-0 text-start">
                                    <h4 class="font-weight-bolder">Doctor / Log-In</h4>
                                    <p class="mb-0">Enter your email and password to sign in</p>
                                </div>

                                <div class="card-body">
                                    <form action="{{ route('doctor.authenticate') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            <input type="email"
                                                class="form-control form-control-lg required @error('email') is-invalid @enderror"
                                        ...
                                        <div class="mb-3">
                                            <input type="password"
                                                class="form-control form-control-lg required @error('password') is-invalid @enderror"
          ...
          background-size: cover;">
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Doctor"</h4>
                                <p class="text-white position-relative">The best way to predict the future is to create
                                    it.</p>
                            </div>
                        </div>
                    </div>
...
{{-- <link href="{{ asset('management/management.css') }}" rel="stylesheet">
<!DOCTYPE html>
...
<body>
    <div class="wrapper">
        <form action="{{ route('manage.authenticate') }}" method="POST">
            @csrf
                ...
                <div>
                    <ul>
                        @foreach ($errors->all() as $error)
                          <h3 style="color:rgb(146, 138, 23)">{{$error}}</h3>
                        @endforeach[[]]
                    </ul>
                </div>
