...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('index_assets/css/animate.css') }}" media="screen" />
    <link rel="stylesheet" href="{{ asset('index_assets/css/slick.css') }}" />
    <link rel="stylesheet" href="{{ asset('index_assets/css/slick-theme.css') }}" />
    <link rel="stylesheet" href="{{ asset('index_assets/css/smk-accordion.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('index_assets/css/jquery.mmenu.all.css') }}" />
    <link rel="stylesheet" href="{{ asset('index_assets/css/style.css?v=2') }}" />
    <link rel="stylesheet" href="{{ asset('index_assets/css/responsive.css') }}" />
...
<body class="homepage">
        ...
        <div class="body-wrapper">
            ...
            <header>
                <div class="container flex-between">
                    <div class="logoblk"><img src="{{ asset('index_assets/images/cardio-rescue-logo.webp') }}"
                            class="img-fluid" /></div>
                    <div class="headerrightblk flex-between">
                        <div class="welcometext">Welcome to Cardiorescue</div>
            ...
            <nav id="menu">
                <ul>
                    ...
                    <li><a data-scroll-nav='4' href="#page" class="mm-close" aria-owns="page">About Cardiorescue</a>
                    </li>
                        ...
                        <div class="banner-slider">
                            ...
                            <div>
                                <div class="banner-blk banner1">
                                    <img src="{{ asset('index_assets/images/banner/banner2.webp') }}" alt=""
                                        class="img-res">
                            ...
                            <div>
                                <div class="banner-blk banner1">
                                    <img src="{{ asset('index_assets/images/banner/banner.webp') }}" alt=""
                                        class="img-res">

                                    <div class="banner-text">
                                        <div class="banner-ttl">Say bye to your pain with,
                                            <br><span>Cardiorescue</span>
                                        </div>
                            ...
                            <div>
                                <div class="banner-blk banner1">
                                    <img src="{{ asset('index_assets/images/banner/banner4.jpg') }}" alt=""
                                        class="img-res">
                            ...
                            {{-- <div>
                                <div class="banner-blk banner1">
                                    <img src="{{ asset('index_assets/images/images/banner/banner3.webp') }}"
                                        alt="" class="img-res">
                        ...
                        <div class="section-wrapp">
                            ...
                            <div class="coutnerwrap" id="counter">
                                <div class="counterinnerwrap">
                                    <div class="dflex">
                                        <div class="icon">
                                            <img src="{{ asset('index_assets/images/icon1.webp') }}"
                                                class="img-fluid">
                                        </div>
                                        <div class="icontxt">
                                ...
                                <div class="counterinnerwrap">
                                    <div class="dflex">
                                        <div class="icon">
                                            <img src="{{ asset('index_assets/images/icon2.webp') }}"
                                                class="img-fluid">
                                        </div>
                                        <div class="icontxt">
                                            <div class="counterblk">
                                ...
                                <div class="counterinnerwrap" data-aos="zoom-in" data-aos-easing="linear">
                                    <div class="dflex">
                                        <div class="icon">
                                            <img src="{{ asset('index_assets/images/icon3.webp') }}"
                                                class="img-fluid">
                                        </div>
                                        <div class="icontxt">
                                            <div class="counterblk">
                ...
                <section class="ourservice_wrapper" data-scroll-index='1'>
                    <div class="container">
                        <div class="section-wrapp ourservice_blk">
                            ...
                            <div class="progresstreatment_blk ">
                                ...
                                <div class="progress_pic">
                                    ...
                                    <img src="{{ asset('index_assets/images/Mobility.webp') }}" class="img-fluid" />
                                </div>
                            </div>
                            <div class=" approachslider marTop40">
                                <div>
                                    <div class="service_item">
                                        <div class="service_pic">
                                            <img src="{{ asset('index_assets/images/Advanced-Assessment.webp') }}"
                                                alt="" class="img-fluid" />
                                        </div>
                                ...
                                <div>
                                    <div class="service_item">
                                        <div class="service_pic">
                                            <img src="{{ asset('index_assets/images/Muscle-Testing.webp') }}"
                                                alt="" class="img-fluid" />
                                        </div>
                                        <div class="service_info">
                                ...
                                <div>
                                    <div class="service_item">
                                        <div class="service_pic">
                                            <img src="{{ asset('index_assets/images/Robotic.webp') }}" alt=""
                                                class="img-fluid" />
                                        </div>
                                        <div class="service_info">
                        ...
                        <div class="button-container-assing">
                            <a href="{{ route('mobilityTest') }}" class="assingButton">FREE ONLINE ASSESSMENT</a>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-slider">
                            ...
                            <div>
                                <div class="testimg wow zoomIn">
                                    <img src="{{ asset('index_assets/images/testimg10.webp?v=1') }}"
                                        class="img-fluid">
                                    <a href="javascript:void(0);" data-fancybox
                                        data-src="https://www.youtube.com/watch?v=3u7e-4eA5pc" class="playicon"><img
                                            src="{{ asset('index_assets/images/playicon.webp') }}"
                                            class="img-fluid"></a>
                                </div>
                            </div>
                            <div>
                                <div class="testimg wow zoomIn">
                                    <img src="{{ asset('index_assets/images/testimg1.webp?v=1') }}"
                                        class="img-fluid">
                                    <a href="javascript:void(0);" data-fancybox
                            ...
                            <div>
                                <div class="testimg wow zoomIn">
                                    <img src="{{ asset('index_assets/images/testimg6.webp?v=1') }}"
                                        class="img-fluid">
                                    <a href="javascript:void(0);" data-fancybox data-src="video/testimonial6.mp4"
                                        class="playicon"><img src="{{ asset('index_assets/images/playicon.webp') }}"
                                            class="img-fluid"></a>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="testimg wow zoomIn">
                                    <img src="{{ asset('index_assets/images/testimg7.webp?v=1') }}"
                                        class="img-fluid">
                            ...
                            <div>
                                <div class="testimg wow zoomIn">
                                    <img src="{{ asset('index_assets/images/testimg8.webp') }}" class="img-fluid">
                            ...
                            <div>
                                <div class="testimg wow zoomIn">
                                    <img src="{{ asset('index_assets/images/testimg9.webp') }}" class="img-fluid">
                                            ...
                                            <div class="tab__content-item">
                                                ...
                                                <div class="knee-injury">
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Hemiplegia.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Paraplegia.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Quadriplegia.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                            ...
                                            <div class="tab__content-item">
                                                ...
                                                <div class="knee-injury">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Tremors.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Balance.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Tightness.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Slow_Movements.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                ...
                                                <div class="knee-injury">
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Injury_Rehab_Services.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                            ...
                                            <div class="tab__content-item">
                                                <div class="knee-injury">
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/1.png') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Arthritis.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/3.png') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/4.png') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                            ...
                                            <div class="tab__content-item">
                                                <div class="knee-injury">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Cervical_Pain.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Lumbar_Pain.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Sciatica.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Slip_Disc.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Disc_Bulge.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Upper_Lower_Back_Pain.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Neck_Pain.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                ...
                                                <div class="knee-injury">
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Hip_Rehabilitation.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/hip.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Avascular_Necrosis.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                            ...
                                            <div class="tab__content-item">
                                                ...
                                                <div class="knee-injury">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Sprain_and_Strain.web') }}p"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Frozen_Shoulder.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Tendinitis.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                                                    ...
                                                    <div class="width23">
                                                        <div class="corcerns-blk">
                                                            ...
                                                            <div class="corcerns-img">
                                                                <img src="{{ asset('index_assets/images/Bursitis.webp') }}"
                                                                    class="img-res" />
                                                            </div>
                                                            <div class="textwrapp">
                    ...
                    <div class="container">
                        <div class="section-wrapp sec5">
                            <div class="whyusimg wow slideInLeft"><img
                                    src="{{ asset('index_assets/images/whyusimg.webp') }}" class="img-fluid">
                            </div>
                ...
                <section data-scroll-index='6' id="enquire">
                    <div class="container">
                        <div class="section-wrapp wow zoomIn" style="margin-bottom: 0">
                            ...
                            <form class="dflex-center formblk" method="post" action="{{ route('appointment') }}"
                                id="appointmentForm">
                                @csrf
                                ...
                                <div class="input_width message">
                                    <input type="text" name="issue" placeholder="Describe Your Issue"
                                        required />
                                </div>
    ...
    <!-- Counter Script -->
    <script src="{{ asset('index_assets/js/jquery-1.11.1.min.js') }}"></script>

    <script type="text/javascript" src="{{ asset('index_assets/js/jquery.mmenu.all.js') }}"></script>
    <script>
    ...
    <script type="text/javascript" src="{{ asset('index_assets/js/scrollIt.min.js') }}"></script>
    <script>
        $(function() {
    ...
    <script src="{{ asset('index_assets/js/wow.js') }}"></script>
    <script src="{{ asset('index_assets/js/smk-accordion.js') }}"></script>
    <script>
        wow = new WOW({
    ...
    <script src="{{ asset('index_assets/js/slick.js') }}"></script>
    <script>
