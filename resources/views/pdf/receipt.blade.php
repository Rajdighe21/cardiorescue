    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td ><strong>{{ $lastRecord->payment_amt}}/- RS </strong></td>
            </tr>
             @if (!empty($lastRecord->pending_amount))
                <tr>
                    <td></td>
                    <td>Due Amount</td>
                    <td></td>
                    <td><strong>{{ $lastRecord->pending_amount }}/- RS </strong></td>
                </tr>
            @endif        </tbody>
    </table>
